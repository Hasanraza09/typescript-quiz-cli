...
const questions: Question[] = [
  ...
  {
    question:
      "Which of the following TypeScript feature allows you to create a blueprint for an object?",
  ...
  {
    question:
      "Which of the following is the correct way to define a union type in TypeScript?",
    choices: [
  ...
  {
    question:
      "What is the output of the following TypeScript code: `console.log(typeof null);`?",
...
async function quiz() {
    let score = 0;
    let incorrectAnswers: {question: string, correctAnswer: string}[] = [];
